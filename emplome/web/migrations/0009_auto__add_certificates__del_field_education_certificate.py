...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_certificates', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('certificate_name', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'web', ['Certificates'])

        # Deleting field 'Education.certificate'
        db.delete_column(u'web_education', 'certificate')

        # Adding M2M table for field certificate on 'Education'
        db.create_table(u'web_education_certificate', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('education', models.ForeignKey(orm[u'web.education'], null=False)),
            ('certificates', models.ForeignKey(orm[u'web.certificates'], null=False))
        ))
        db.create_unique(u'web_education_certificate', ['education_id', 'certificates_id'])

    def backwards(self, orm):
        # Deleting model 'Certificates'
        db.delete_table(u'web_certificates')

        # Adding field 'Education.certificate'
        db.add_column(u'web_education', 'certificate',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field certificate on 'Education'
        db.delete_table('web_education_certificate')
    ...
    models = {
        ...
        u'web.education': {
            ...
            'basic_edu_specialization': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'certificate': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['web.Certificates']", 'null': 'True', 'blank': 'True'}),
            'doctrate': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['web.Doctorate']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'masters': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'masters_specialization': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'web.employment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'previous_employer': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['web.PreviousEmployer']", 'null': 'True', 'blank': 'True'}),
