...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.last_date'
        db.alter_column(u'web_job', 'last_date', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Job.last_date'
        db.alter_column(u'web_job', 'last_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Job.posting_date'
        db.alter_column(u'web_job', 'posting_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    models = {
        u'auth.group': {
