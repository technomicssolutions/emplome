...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyProfile.job'
        db.alter_column(u'web_companyprofile', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Job'], null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CompanyProfile.job'
        raise RuntimeError("Cannot reverse this migration. 'CompanyProfile.job' and its values cannot be restored.")
    models = {
        u'auth.group': {
