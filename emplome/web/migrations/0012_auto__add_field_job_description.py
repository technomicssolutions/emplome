...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'web_job', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=1500, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Job.description'
        db.delete_column(u'web_job', 'description')
