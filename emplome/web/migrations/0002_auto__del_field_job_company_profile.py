...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Job.company_profile'
        db.delete_column(u'web_job', 'company_profile')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Job.company_profile'
        raise RuntimeError("Cannot reverse this migration. 'Job.company_profile' and its values cannot be restored.")
    models = {
        u'auth.group': {
