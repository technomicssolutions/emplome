...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'JobSeekerProfile.religion'
        db.delete_column(u'web_jobseekerprofile', 'religion')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'JobSeekerProfile.religion'
        db.add_column(u'web_jobseekerprofile', 'religion',
