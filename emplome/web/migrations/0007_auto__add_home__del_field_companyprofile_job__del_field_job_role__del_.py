...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CompanyProfile.job'
        db.delete_column(u'web_companyprofile', 'job_id')

        # Deleting field 'Job.role'
        db.delete_column(u'web_job', 'role')

        # Deleting field 'Job.other_education'
        db.delete_column(u'web_job', 'other_education')
        ...
        # Changing field 'Education.resume'
        db.alter_column(u'web_education', 'resume', self.gf('django.db.models.fields.files.FileField')(max_length=30000, null=True))
    def backwards(self, orm):
        # Deleting model 'Home'
        db.delete_table(u'web_home')

        # Adding field 'CompanyProfile.job'
        db.add_column(u'web_companyprofile', 'job',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Job'], null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Job.role'
        raise RuntimeError("Cannot reverse this migration. 'Job.role' and its values cannot be restored.")
        # Adding field 'Job.other_education'
        db.add_column(u'web_job', 'other_education',
        ...
        # Changing field 'Education.resume'
        db.alter_column(u'web_education', 'resume', self.gf('django.db.models.fields.files.FileField')(max_length=20000, null=True))
    models = {
        u'auth.group': {
        ...
        u'web.home': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recomendations': ('django.db.models.fields.files.FileField', [], {'max_length': '20000', 'null': 'True', 'blank': 'True'}),
            'success_stories': ('django.db.models.fields.files.FileField', [], {'max_length': '30000', 'null': 'True', 'blank': 'True'})
        },
        u'web.job': {
