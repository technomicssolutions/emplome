...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_doctorate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('doctorate_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'web', ['Doctorate'])

        # Deleting field 'Education.doctrate'
        db.delete_column(u'web_education', 'doctrate')

        # Adding M2M table for field doctrate on 'Education'
        db.create_table(u'web_education_doctrate', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('education', models.ForeignKey(orm[u'web.education'], null=False)),
            ('doctorate', models.ForeignKey(orm[u'web.doctorate'], null=False))
        ))
        db.create_unique(u'web_education_doctrate', ['education_id', 'doctorate_id'])

    def backwards(self, orm):
        # Deleting model 'Doctorate'
        db.delete_table(u'web_doctorate')

        # Adding field 'Education.doctrate'
        db.add_column(u'web_education', 'doctrate',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field doctrate on 'Education'
        db.delete_table('web_education_doctrate')
