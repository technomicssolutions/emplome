...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'JobSeekerProfile.current_location'
        db.delete_column(u'web_jobseekerprofile', 'current_location')

    def backwards(self, orm):
        # Adding field 'JobSeekerProfile.current_location'
        db.add_column(u'web_jobseekerprofile', 'current_location',
