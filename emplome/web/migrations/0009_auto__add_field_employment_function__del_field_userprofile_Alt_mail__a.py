...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employment.function'
        db.add_column(u'web_employment', 'function',
        ...
        db.alter_column(u'web_userprofile', 'mobile', self.gf('django.db.models.fields.CharField')(max_length=20))
        # Adding field 'Education.resume_title'
        db.add_column(u'web_education', 'resume_title',
    ...
    def backwards(self, orm):
        # Deleting field 'Employment.function'
        db.delete_column(u'web_employment', 'function')
        ...
        # Changing field 'UserProfile.mobile'
        db.alter_column(u'web_userprofile', 'mobile', self.gf('django.db.models.fields.IntegerField')())
        # Deleting field 'Education.resume_title'
        db.delete_column(u'web_education', 'resume_title')
