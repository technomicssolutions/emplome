...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SuccessStory.publish'
        db.add_column(u'web_successstory', 'publish',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SuccessStory.publish'
        db.delete_column(u'web_successstory', 'publish')
