...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.document'
        db.alter_column(u'web_job', 'document', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Job.summary'
        db.alter_column(u'web_job', 'summary', self.gf('django.db.models.fields.CharField')(max_length=500))
    def backwards(self, orm):

        # Changing field 'Job.document'
        db.alter_column(u'web_job', 'document', self.gf('django.db.models.fields.files.FileField')(max_length=20000, null=True))

        # Changing field 'Job.summary'
        db.alter_column(u'web_job', 'summary', self.gf('django.db.models.fields.CharField')(max_length=250))
    models = {
        u'auth.group': {
