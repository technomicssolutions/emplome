...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_previousemployer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('previous_employer_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'web', ['PreviousEmployer'])

        # Adding M2M table for field previous_employer on 'Employment'
        db.create_table(u'web_employment_previous_employer', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('employment', models.ForeignKey(orm[u'web.employment'], null=False)),
            ('previousemployer', models.ForeignKey(orm[u'web.previousemployer'], null=False))
        ))
        db.create_unique(u'web_employment_previous_employer', ['employment_id', 'previousemployer_id'])

    def backwards(self, orm):
        # Deleting model 'PreviousEmployer'
        db.delete_table(u'web_previousemployer')

        # Removing M2M table for field previous_employer on 'Employment'
        db.delete_table('web_employment_previous_employer')
