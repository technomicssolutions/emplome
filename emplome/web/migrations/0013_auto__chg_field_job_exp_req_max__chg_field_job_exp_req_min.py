...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.exp_req_max'
        db.alter_column(u'web_job', 'exp_req_max', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Job.exp_req_min'
        db.alter_column(u'web_job', 'exp_req_min', self.gf('django.db.models.fields.IntegerField')(null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Job.exp_req_max'
        raise RuntimeError("Cannot reverse this migration. 'Job.exp_req_max' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Job.exp_req_min'
        raise RuntimeError("Cannot reverse this migration. 'Job.exp_req_min' and its values cannot be restored.")
    models = {
        u'auth.group': {
