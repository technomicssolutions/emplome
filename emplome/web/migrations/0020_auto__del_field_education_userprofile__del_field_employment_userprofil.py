...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Education.userprofile'
        db.delete_column(u'web_education', 'userprofile_id')

        # Deleting field 'Employment.userprofile'
        db.delete_column(u'web_employment', 'userprofile_id')

        # Adding field 'JobSeekerProfile.education'
        db.add_column(u'web_jobseekerprofile', 'education',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Education'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobSeekerProfile.employment'
        db.add_column(u'web_jobseekerprofile', 'employment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Employment'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Education.userprofile'
        raise RuntimeError("Cannot reverse this migration. 'Education.userprofile' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Employment.userprofile'
        raise RuntimeError("Cannot reverse this migration. 'Employment.userprofile' and its values cannot be restored.")
        # Deleting field 'JobSeekerProfile.education'
        db.delete_column(u'web_jobseekerprofile', 'education_id')

        # Deleting field 'JobSeekerProfile.employment'
        db.delete_column(u'web_jobseekerprofile', 'employment_id')
